...
//J     extern char buffers[][];
        ...
        if ( (bp->b_flags & B_PHYS) == 0 ) {
                ...
                UNIX_ptaccess(bp->b_proc, Mbamap, mbautl);      /* get to u-area & page tables */
                io = (int *)mbap;
                io += (MBA_MAP + 128*4)/4;
